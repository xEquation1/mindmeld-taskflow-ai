...
import { Mail, FileText, CalendarClock, Sparkles } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
      ...
      <SidebarHeader className="border-b">
        <div className="flex items-center gap-2 px-2 py-3">
          ...
          <div className="min-w-0 group-data-[collapsible=icon]:hidden">
            <div className="truncate text-sm font-semibold">TaskMind</div>
            <div className="truncate text-xs text-muted-foreground">AI Productivity</div>
          </div>
        </div>
      </SidebarHeader>
      <SidebarContent>
